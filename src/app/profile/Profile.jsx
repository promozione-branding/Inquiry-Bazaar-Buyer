...
import AdditionalInfoForm from "@/components/Buyer/Profile/AdditionalInfoForm";
import SocialForm from "@/components/Buyer/Profile/SocialForm";
import EditModal from "@/components/Buyer/Profile/EditModal";
    ...
    <div className="p-2 md:p-4 w-full bg-gray-100">
      <div className="grid lg:grid-cols-3 xl:gap-5 gap-3">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-white rounded-xl shadow p-2 md:flex hidden flex-wrap gap-1">
            {tabs.map((tab) => {
              const Icon = tab.icon;
              return (
